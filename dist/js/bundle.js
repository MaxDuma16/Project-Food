...
function cards() {
    ...
    // Вариант 1
    Object(_services_servises__WEBPACK_IMPORTED_MODULE_0__["getResource"])('http://localhost:3000/menu')
        .then(data => {
...
//             data.for.forEach(({img, altimg, title, descr, price}) => {
//                 const element = document.createElement('div');
...
//         }
    ...
    // //  Вариант 3 через библиотеку https://github.com/axios/axios
...
function forms(formSelector, modalTimerId) {
    ...
    const message = {
        ...
        success: 'Спавибо! Ми с Вами свяжемся!',
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
           ...
           // form.append(statusMessage);
            ...
            Object(_services_servises__WEBPACK_IMPORTED_MODULE_1__["postData"])('http://localhost:3000/requests', json)
            .then(data => {
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    const modalTimerId = setTimeout(() => Object(_modules_modal__WEBPACK_IMPORTED_MODULE_1__["openModal"])('.modal', modalTimerId), 50000);
     ...
     Object(_modules_timer__WEBPACK_IMPORTED_MODULE_5__["default"])('.timer', '2020-12-30');
